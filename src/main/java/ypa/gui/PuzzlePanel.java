...
public class PuzzlePanel extends javax.swing.JPanel {
    ...
    private void paintCircle(Graphics g) {
        ...
        final int delta_x = ((int) (0.3 * cellSize) - fm.charWidth('0')) / 2 + 1;
        final int delta_y = ((int) (0.9 * cellSize) - fm.getAscent() + fm.getDescent()) / 2;
        ...
        final int circleDiameter = cellSize - (int) (0.5 * cellSize); // Circle 50% of cell size
    ...
    private void drawFilledCircle(Graphics g, int x, int y, int diameter, int adjustment) {
        Color veryLightRed = new Color(255, 200, 200);
        g.setColor(veryLightRed);
